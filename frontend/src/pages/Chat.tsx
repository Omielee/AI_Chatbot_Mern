...
import { deleteUserChats, getUserChats, sendChatRequest } from '../helpers/api_communicators';
...
const handleDeleteChats = async () => {
  try {
    toast.loading("Deleting the chats",{id:"deletechats"})
  ...
  useLayoutEffect(() => {
    if (auth?.isLoggedIn && auth.user) {
      ...
      getUserChats()
        ...
        toast.success("Successfully",{id:"loadchats"})
      })
        .catch(err=>{
        console.log(err);
